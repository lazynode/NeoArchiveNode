...
public partial class plugin
{
    string get_invocation(string script, string signer)
    {
        ...
        Transaction transaction = signer.WalletByWif(system!.Settings).MakeTransaction(system!.StoreView, script.HexToBytes(), signer.UInt160ByWif());
        ...
        json["txjson"] = transaction.ToJson(system!.Settings).ToString();
